 ...
 //text editing controllers
  ...
  void signUp() async {
    ...
    try {
      ...
      //after creating the user, create a new document in cloud firestore calledd Users
      FirebaseFirestore.instance
            .collection("Users")
            .doc(userCredential.user!.email)
            .set({
              'username': emailTextController.text.split('@')[0], //inittial username
              'bio': 'Empty bio..' //initially empty bio
              //add any additional fields as needed
            });

      //pop loading circle after creating user
